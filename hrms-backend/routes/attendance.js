  ...
  try {
    ...
    if (status) {
      const validStatuses = [
        ...
        'Present [LA: Deducted(CL)]', 'Present [LA: Deducted(Compensatory)]', 'Present [LA: Deducted(Salary)]',
        'FN: Present (LA) & AN: Present', 'FN: Present [LA: Approval Pending] & AN: Present', 
        'FN: Present [LA: Allowed] & AN: Present','FN: Present [LA: Approval Pending]' ,'FN: Present [LA: Deducted(CL)] & AN: Present', 
